...
function processVerticalMerges(grid) {
  ...
  for (let c = 0; c < COLS; c++) {
    for (let r = ROWS - 2; r >= 0; r--) {
      ...
      // Fibonacci+ mode: only INCREASING merges (1+1=2, 1+2=3, etc. - no decrease)
...
export default function MergeDropFibonacciPlus() {
  ...
  useEffect(() => {
    getGameStats("fibonacci_plus").then(stats => {
  ...
  useEffect(() => {
    ...
    saveGameResult("fibonacci_plus", score, turn, duration).then(result => {
      if (result) {
        ...
        <div onClick={() => setShowRules(false)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ fontSize: 13, color: "#997777", lineHeight: 2 }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 6 }}>
                <span style={{ color: "#CC6666", fontWeight: 700, minWidth: 16 }}>↓</span>
                <span><b style={{ color: "#CC9999" }}>No decrease:</b> Smaller number on top of larger does nothing</span>
              </div>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 6 }}>
                <span style={{ color: "#CC6666", fontWeight: 700, minWidth: 16 }}>↔</span>
